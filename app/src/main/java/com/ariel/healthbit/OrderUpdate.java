...
public class OrderUpdate{
    ...
    public OrderUpdate(String userUid, ArrayList<productOrder> itemQuantity, Double priceD) {
    }
     ...
     * @param  orderUpdate Input the Order node to create.
     */
    public OrderUpdate(OrderUpdate orderUpdate)
    {
        this.userUID= orderUpdate.userUID;
        this.totalPrice= orderUpdate.totalPrice;
        this.itemQuantity= orderUpdate.itemQuantity;
    }
     ...
     */
    public OrderUpdate(String userUID){
